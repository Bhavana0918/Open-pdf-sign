...
### key certificate
Install Self-signed key and certificate
openssl genpkey -algorithm RSA -out keyfile.pem -pkeyopt rsa_keygen_bits:2048
openssl req -new -x509 -key keyfile.pem -out certificate.crt -days 365
ls certificate.crt keyfile.pem

Add input.pdf that you want to sign in root of project directory.
